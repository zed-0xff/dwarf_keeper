...
injectlib-memserver.dylib: 8-injectlib-http.cpp unicode.cpp dwarf.cpp item.cpp html.cpp clothes.cpp common.h items_controller.cpp http_request.cpp creatures_controller.cpp
